...
🗂️ Data Modeling – Established relationships between tables for accurate analysis and reporting.
📁 Dataset – Super Store Sales dataset containing sales, profit, customer, product, and shipping information.
...
The goal of this dashboard is to provide a clear and interactive view of retail sales performance by tracking key business metrics such as sales, profit, quantity, customer segments, regions, and shipping methods. It helps businesses identify trends, monitor performance, and make data-driven decisions to improve sales, profitability, and overall business growth.

📈 Business Impact & Insights
Increased visibility into overall sales, profit, and business performance.
Identified top-performing regions, products, and customer segments.
Helped track monthly sales and profit trends to support better forecasting.
Revealed customer purchasing patterns and preferred payment methods.
Evaluated shipping performance to improve delivery efficiency.
